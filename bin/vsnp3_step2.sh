...
printf "Node Name:\t$SLURMD_NODENAME\n"

echo "Scripts from this location:"
...
# sbatch vsnp3_step2.sh -t Mycobacterium_H37 --remove
# sbatch vsnp3_step2.sh --wd ../vcf_source
# sbatch vsnp3_step2.sh -t NC_045512_wuhan-hu-1 -remove # when working directory contains vcf files
# sbatch vsnp3_step2.sh -t NC_045512_wuhan-hu-1 -wd ../vcf_source
# sbatch vsnp3_step2.sh -a -t NC_045512_wuhan-hu-1 -remove
